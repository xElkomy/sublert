...
# bypass Discord rate limit when using free workplace, switch to False if you're using Pro/Ent version.
discord_sleep_enabled = True
# Add @channel notifications to Discord messages, switch to False if you don't want to use @channel
